...
/**
 * Created by filip on 07.11.2015.
 */
class Point {
...
class Board {
    ...
    public int alphaBetaMinimax(int alpha, int beta, int depth, int turn){
        ...
        for(int i=0;i<pointsAvailable.size(); ++i){
            ...
            if(turn == 1){
                //minimaxActivity.setMove(point, 1);
                //placeAMove(point, 1);
                ...
                //minimaxActivity.setMove(point, 2);
                //placeAMove(point, 2);
    ...
    public Point getComputerPoint() {
        ...
        int move = alphaBetaMinimax(Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 2);

        b.alphaBetaMinimax(Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 2);
    ...
    public void MMPoint(){
        alphaBetaMinimax(Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 2);
    }
